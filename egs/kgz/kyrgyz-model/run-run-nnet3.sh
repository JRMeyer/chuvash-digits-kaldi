...
# baseline
./run_nnet3_multilingual.sh "libri-org" "tri" "1.0" $dim $num_epochs "2gramWiki_${num_epochs}epoch_5layer_${dim}dim_BASELINE" "tree" "0"
...
./run_nnet3_multilingual.sh "libri-org libri-voice" "tri tri" "1.0,1.0" $dim $num_epochs "2gramWiki_${num_epochs}epoch_5layer_${dim}dim_VOICE" "tree tree" "0"
